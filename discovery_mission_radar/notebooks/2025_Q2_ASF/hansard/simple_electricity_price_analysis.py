#!/usr/bin/env python3
"""
Simple script to analyze Hansard speeches for mentions of electricity prices and costs.
...
def create_simple_electricity_price_keywords():
...
def analyze_electricity_prices():
    ...
    keywords_dict = create_simple_electricity_price_keywords()
